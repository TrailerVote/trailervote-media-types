  ...
  module MediaTypes
    class ErrorsTest < Minitest::Test
      ...
      def test_the_default_media_type
        ...
        assert_equal 'application/vnd.trailervote.errors.v1+json', Errors.to_constructable.to_s
      end

      def test_it_registers
        assert_media_types_registered(Errors) do
          formatted_mime_type 'application/vnd.trailervote.errors.v%<version>s+json' do
            version 1, symbol: :errors_v1_json
          end
        end
      end
